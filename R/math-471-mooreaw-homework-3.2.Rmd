...
**b.** I'm not sure what exactly this is asking.
...
**a.** Histogram and QQ-plot for the body-mass data (*including* the outlier).

```{r q4114-a, fig.width=8}
m <- qq_df(mass)
...
**b.** Histogram and QQ-plot for the body-mass data (*excluding* the outlier).

```{r q4114-b, fig.width=8}
